...
%>
<link rel="stylesheet" href="<%=webPath%>/jsp/cform/procdef/html/skin/css/prompt.css" />
...
<script type="text/javascript" src="<%=webPath%>/jsp/cform/procdef/html/common/prompt.js"></script>
<!-- 引入国际化文件 -->
