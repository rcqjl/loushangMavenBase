...
<script type="text/javascript" src="<%=webPath%>/jsp/cform/procdef/html/form/formauth.js"></script>
...
<body>
	...
	<div id="content" class="right">
		...
		<label><spring:message code="CForm.BPM.D230" text="区域名称"/>:</label><input id="containerName" type="text" readonly="readonly"><label class="hide" for="hide"><spring:message code="CForm.BPM.D231" text="隐藏"/>:</label><input class="hide" type="checkbox">
		</div>
		<div id="table" class="rightBottom">
		<table>
			<thead>
				<tr>
					<th style="width:160px;text-align:left;text-align: left;padding-left: 10px;"><spring:message code="CForm.BPM.D232" text="表单域名称"/></th>
