...
function showDialog(mode, msg, t, sd_width, isHideCancel,fn) {
	...
	var t = t ? t : L.getLocaleMessage("CForm.BPM.D191","提示信息");
	var msg = msg ? msg : "";
	var confirmtxt = confirmtxt ? confirmtxt : L.getLocaleMessage("CForm.BPM.D185","确定");
	var canceltxt = canceltxt ? canceltxt : L.getLocaleMessage("CForm.BPM.D186","取消");
	...
	try {
		...
		SD_html += "</div></div>";
		SD_html += "<a href='javascript:;' id='SD_close' title='"+L.getLocaleMessage("CForm.BPM.D276","关闭")+"'></a>";
		SD_html += "</td>";
		...
		alert(L.getLocaleMessage("CForm.BPM.D277","系统异常！"));
	}
}
...
function showWindow1(title, the_url, sd_width, sd_height, param, fn) {
	...
	try {
		...
		SD_html += "<a href='javascript:;' id='SD_close1' title='"+L.getLocaleMessage("CForm.BPM.D276","关闭")+"'></a>";
		SD_html += "</td>";
