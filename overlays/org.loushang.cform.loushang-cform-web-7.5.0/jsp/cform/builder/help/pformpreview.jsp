...
<link rel="stylesheet" href="<%=contextPath%>/jsp/cform/skin/css/pcform.css">
<link rel="stylesheet" href="<%=contextPath%>/jsp/cform/skin/css/jquery.mobiscroll.css">

<script src="<%=contextPath%>/jsp/cform/skin/js/jquery.js"></script>
<l:script path="i18n.js"/>
<script src="<%=contextPath%>/jsp/cform/skin/js/pcform.js"></script>
<script src="<%=contextPath%>/jsp/cform/skin/js/jquery.mobiscroll.js"></script>
</head>
<body class="cfBody">
	<!-- 表单内容(html) -->
</body>
