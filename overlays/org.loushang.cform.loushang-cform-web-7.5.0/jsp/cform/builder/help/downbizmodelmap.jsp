...
<html>
	<head>
		<title><s:message code="cf.bdr.downmapping" text="下行映射"/></title>
		...
		<script src="<l:assetcontext/>/jsp/cform/builder/help/downbizmodelmap.js"></script>
	</head>
	<body>
		<div style="height:425px;">
			<div class="leftFrame"><ul id="targetTreeContainer" class="ztree"></ul></div>
			<div class="rightFrame"><ul id="sourceTreeContainer" class="ztree"></ul></div>
		</div>
		<div class="foot">
