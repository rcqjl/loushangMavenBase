...
(function($) {
	...
	var overrides = {
		dateTimeTpl : '<div cf_widgetId="{widgetId}" class="phone_widget phone_widget_date">'
		...
		drop : function(e, target) {
			...
			showWindow(L.getLocaleMessage("cf.widget.dateattr", "日期框属性"), "mwidget/base/date/dateattr.jsp", 400, 400,
	...
	CFMDate = $.inherit(CFWidget, overrides);
	// 注册组件
	CForm.reg(CFMDate);
})(jQuery);