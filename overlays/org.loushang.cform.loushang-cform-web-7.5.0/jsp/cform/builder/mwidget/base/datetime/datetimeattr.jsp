...
<html>
	<head>
		<title><s:message code="cf.widget.datetimeattr" text="日期时间框属性"/></title>
	...
	<body>
		<div class="ui-tabs">
			<ul class="ui-tabs-nav">
				...
				<li><s:message code="cf.widget.datetimeformat" text="日期时间格式"/></li>
			</ul>
			<div id="baseAttrDiv" class="ui-tabs-panel">
				<ul>
					<li><label for="fieldName" style="width:110px;"><s:message code="cf.name" text="名称"/></label><input type="text" id="fieldName" name="<s:message code="cf.name" text="名称"/>" class="cfIsRequired"></input></li>
					...
					<li><label for="fieldId" style="width:110px;">ID</label><input type="text" id="fieldId" name="ID" class="cfIsRequired cfNotStartWithNum"></input></li>	
					<li><input type="checkbox"	id="currentDate" name="currentDate" style="display:inline;"/><label for="currentDate" style="display:inline;"><s:message code="cf.widget.showcurdatetime" text="显示当前日期时间"/></label></li>
				</ul>
			</div>
			<div id="formatDiv" class="ui-tabs-panel ui-tabs-hide">
				<ul style="margin-top:15px;">
					<li>
						<input type="radio" id="yy-mm-dd" name="dateFormat" value="yy-mm-dd HH:ii:ss" style="display:inline;"/><label style="width:200px;"  class="rightLabel" for="yy-mm-dd" style="display:inline;"><s:message code="cf.widget.yy-mm-ddHHiiss" text="年-月-日  时:分:秒"/></label>
					</li>
					<li>
						<input type="radio" id="yy/mm/dd" name="dateFormat" value="yy/mm/dd HH:ii:ss" style="display:inline;"/><label style="width:200px;" class="rightLabel" for="yy/mm/dd" style="display:inline;"><s:message code="cf.widget.yy/mm/ddHHiiss" text="年/月/日  时:分:秒"/></label>
					</li>
					<li>
						<input type="radio" id="yymmdd" name="dateFormat" value="yymmdd HH:ii:ss" style="display:inline;"/><label style="width:200px;" class="rightLabel" for="yymmdd" style="display:inline;"><s:message code="cf.widget.yymmddHHiiss" text="年月日  时:分:秒"/></label>
					</li>
					<li>
						<input type="radio" id="customFormat" name="dateFormat" value="custom" style="display:inline;"/><label style="width:200px;" class="rightLabel" for="customFormat" style="display:inline;"><s:message code="cf.widget.customformat" text="自定义格式"/></label>
					</li>
					<li>
					...
					<li style="color:#828282;line-height:20px;">
						...
						<s:message code="cf.widget.datetimewidgetnote" text="yy代表年;mm代表月;dd代表日;HH代表时;ii代表分;ss代表秒"/></p>
					</li>
				</ul>
