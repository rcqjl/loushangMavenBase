...
(
            ...
            ACT_DEF_UNIQUE_ID VARCHAR2 (32) ,
            ACT_DEF_ID VARCHAR2 (32) ,
            ACT_DEF_NAME VARCHAR2 (100) ,
            ...
            PRE_ACT_DEF_NAMES VARCHAR2 (255) ,
            PRE_ORGAN_NAMES VARCHAR2 (255) ,
            PRIMARY_KEY VARCHAR2 (32) ,
            PROCESS_TYPE VARCHAR2 (32) ,
            IS_VISIBLE CHAR (1),
            SYS_SUBJECT VARCHAR2(512),
            PROC_SUBJECT VARCHAR2(512),
            TYPE_SUBJECT VARCHAR2(512),
...
(
            ...
            PROC_CREATOR_ID VARCHAR (32) ,
            PROC_CREATOR_NAME VARCHAR (100) ,
            IS_PROC_END CHAR (1) DEFAULT ' ' ,
            ACTIVE_ACT_DEF_NAMES VARCHAR2 (255) ,
            ACTIVE_ORGAN_NAMES VARCHAR2 (255) ,
            PRIMARY_KEY VARCHAR2 (32) ,
            PROCESS_TYPE VARCHAR2 (32),
            SYS_SUBJECT VARCHAR2(512),
            PROC_SUBJECT VARCHAR2(512),
