...
<html>
	<head>
		<title><%=res.getLocaleMsg("UI.BPM.BUSINESSPROCESSMODEL.028","流程定义修改")%></title>
	...
	<body>
		...
		<script>
			var url=document.URL.replace("forupdatebusinessprocessmodeldef.jsp","fullscreenupdatebusinessprocessmodeldef.jsp");
			var backUrl = 'jsp/workflow/businessprocessmodel/querybusinessprocessmodeldef.jsp';
