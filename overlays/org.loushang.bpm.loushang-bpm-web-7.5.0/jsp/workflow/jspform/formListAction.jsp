	...
	<div class="container">
			<form class="form-inline" onsubmit="return false">	
				<div class="input-group">									
					<input type="text" class="form-control ue-form" id="searchId" placeholder="<spring:message code="BPM.JSPFORM.OperatingName" text="操作名称"></spring:message>"/>											
			...
			<table id="formList" class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th width="20%"><spring:message code="BPM.JSPFORM.OperatingID" text="操作ID"></spring:message></th>
						<th width="35%"><spring:message code="BPM.JSPFORM.OperatingName" text="操作名称"></spring:message></th>
						<th width="20%"><spring:message code="BPM.JSPFORM.OperatingFunc" text="操作函数"></spring:message></th>
						<th width="10%"><spring:message code="BPM.JSPFORM.OperatingType" text="表单类型"></spring:message></th>
...
function retrieveData( sSource, aoData, fnCallback ) {
	var draw=null;
	var cmd = new L5.Command("org.loushang.workflow.jspform.formdef.action.cmd.ActionQueryCmd");
	var rData;
	...
	if($("#searchId").val()){
		cmd.setParameter("ACTION_NAME@like",$("#searchId").val());
	}
	cmd.execute("query");
...
function update(id){
	$.dialog({
		...
		url: "modifyFormAction.jsp?id=" + id+"&formId="+ formId,
		width: 500,
		height: 305,
        onclose: function () {
            $("#formList").DataTable().ajax.reload();
...
$(function(){
	...
	$("#add").click(function(){
		...
		$.dialog({
	         type: 'iframe',
	         url: "modifyFormAction.jsp?status=new&formId="+ formId,
