...
<body>
<model:datasets>
	<model:dataset id="actDataSet" cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" autoLoad="true" method="selectNextActivitiesIncludeCurrentActivity">
		<model:record >
