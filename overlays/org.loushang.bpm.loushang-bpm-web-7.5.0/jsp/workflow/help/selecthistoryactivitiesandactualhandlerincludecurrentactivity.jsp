...
<body>
<model:datasets>
	<model:dataset id="actDataSet" cmd="org.loushang.workflow.client.common.help.cmd.TaskHelpCmd" autoLoad="true" method="selectHistoryActivitiesIncludeCurrentActivity">
		<model:record >
...
$(document).ready(function(){
	...
	for(var i=0;i<data.length;i++) {
		var option = "<option value='"+ data[i].activityId + "@" + data[i].actDefUniqueId +"'>"+ data[i].actDefName +"</option>";
		options += option;	
	}
