...
<link rel="stylesheet" href="<%=webPath%>/jsp/workflow/infoprocessmodel/bizform/skin/css/dynamicpara.css" />
...
<script type="text/javascript" src="<%=webPath%>/jsp/workflow/infoprocessmodel/bizform/view/dynamicpara.js"></script>
		...
		<div class="mainArea">
			...
			<div class="defTable">
				<table>
					<thead>
						<tr>
							<th><spring:message code="BPM.INFOPROCESSMODEL.C055" text="相关数据"/></th>
							<th><spring:message code="BPM.INFOPROCESSMODEL.C056" text="参数key"/></th>
							<th style="width: 40px;"><spring:message code="BPM.INFOPROCESSMODEL.C004" text="删除"/></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
