...
<head>
	...
	<script type="text/javascript" src="parturldef.js"></script>
</head>
<body>
	<div class="container">
			<form class="form-inline" onsubmit="return false">	
				<div class="input-group">									
					<input type="text" class="form-control ue-form" id="searchId" placeholder="<spring:message code="BPM.INFOPROCESSMODEL.Name" text="名称"/>"/>											
			...
			<table id="formList" class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th width="20%"><spring:message code="BPM.INFOPROCESSMODEL.Name" text="名称"/></th>
						<th width="40%"><spring:message code="BPM.INFOPROCESSMODEL.ParticipantsPath" text="参与者路径"/></th>
						<th width="9%"><spring:message code="BPM.INFOPROCESSMODEL.IsDisplay" text="是否显示"/></th>
						<th width="9%"><spring:message code="BPM.INFOPROCESSMODEL.DisplayOrder" text="显示顺序"/></th>
						<th width="9%"><spring:message code="BPM.INFOPROCESSMODEL.Type" text="类别"/></th>
