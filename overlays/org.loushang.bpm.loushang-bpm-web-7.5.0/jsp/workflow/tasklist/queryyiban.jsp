...
<head>
	...
	<script type="text/javascript" src="queryyiban.js"></script>
	...
	<div class="container">
			...
			<table id="formList" class="table table-bordered table-hover">
				<thead>
					<tr>
						<th width="3%"></th>
						<th width="20%"><spring:message code="BPM.TASKLIST.Title" text="标题"/></th>
						...
						<th width="10%"><spring:message code="BPM.TASKLIST.Cur-act-step" text="当前活动环节"/></th>
						<th width="12%"><spring:message code="BPM.TASKLIST.Del-man" text="当前环节处理人"/></th>
						<th width="12%"><spring:message code="BPM.TASKLIST.W-inittime" text="流程发起时间"/></th>
						<th width="12%"><spring:message code="BPM.TASKLIST.T-complettime" text="任务完成时间"/></th>
					</tr>
				</thead>
			</table>
	</div>
